...
const chatHTML = `<main class="flex flex-column">
  <header class="title-bar flex flex-row flex-center">
    <div class="title-wrapper block center-element">
      <img class="logo" src="feather.png"
        alt="Feathers Logo">
  ...
  if(userList) {
    ...
    userList.innerHTML += `<li>
      <a class="block relative" href="#">
        <img crossorigin="anonymous" src="${user.avatar}" alt="" class="avatar">
...
const addMessage = message => {
  ...
  if(chat) {
    chat.innerHTML += `<div class="message flex flex-row">
      <img crossorigin="anonymous" src="${user.avatar}" alt="${user.name || user.email}" class="avatar">
